...
public class Main {
    public static void main(String[] args) {
        ...
        Transaction biggestExpense = TransactionAnalyzer.findBiggestExpense(transactions, "01-01-2023", "31-12-2023");
        Transaction smallestExpense = TransactionAnalyzer.findSmallestExpense(transactions, "01-01-2023", "31-12-2023");

        System.out.println("\nНайбільша витрата: " + (biggestExpense != null ? biggestExpense : "Витрат не знайдено"));
